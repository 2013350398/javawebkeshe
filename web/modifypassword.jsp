...
<H1><font color="BLACK" align="center">请输入旧密码进行验证，并设置新密码：</font></H1>
<form method="POST" action="/user.do?method=modifyPassword&id=<%=u.getUid()%>" >
    <p align="center">
        <span>旧密码</span>
        <input type="text" name="oldpassword" style="background-color:#fff">
    <p align="center">
        <span>新密码</span>
